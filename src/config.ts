...
const configurations: { [env: string]: Configuration } = {
  ...
  //     'BOMB-BTC-LP': ['0x2A651563C9d3Af67aE0388a5c8F89b867038089e', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  //   closedForStaking: true,
  // },
  // BombFtmLPBombRewardPool: {
  //   name: 'Earn BOMB by BOMB-BNB LP',
  //   poolId: 0,
  //   sectionInUI: 1,
  //   contract: 'BombFtmLpBombRewardPool',
  ...
  //   closedForStaking: false,
  // },
  // BshareFtmLPBShareRewardPool: {
  //   name: 'Earn BSHARE by BSHARE-BNB LP',
  //   poolId: 1,
  //   sectionInUI: 2,
  //   contract: 'BshareFtmLPBShareRewardPool',
